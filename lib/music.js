 ...
 *
 * @example
 * music.toFrequency('A', music.NATURAL, 4);
 * // 440
 * music.toFrequency('A', 0, 4);
 * // 440
 * music.toFrequency('E', music.FLAT, 2);
 * // 77.78...
 * music.toFrequency('E', 5, 4);
 * // 440
 *
 * @param {string} note
 *   The note name (e.g. 'A').
 ...
 */
module.exports.toFrequency = function(note, accidental, octave) {
  // The reference pitch:
  var a4 = 440;
