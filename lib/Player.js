...
module.exports = function(controller) {
  ...
  var load = this.load = function(map) {
    ...
    // Everything above is blocking, so this works:
    self.emit(module.exports.EVENT_LOAD);
  };
  ...
  var pause = this.pause = function() {
    ...
    controller.silence();
    state.playing = false;
    self.emit(module.exports.EVENT_PAUSE);
  ...
  var play = this.play = function() {
    ...
    state.playing = true;
    self.emit(module.exports.EVENT_PLAY);
  ...
  var stop = this.stop = function() {
    ...
    self.emit(module.exports.EVENT_STOP);
  };
...
/**
 * Indicates that note changes have finished loading.
 * @constant
 */
module.exports.EVENT_LOAD = 'load';

/**
 * Indicates that the player has been paused (note: triggered on stop as well).
 * @constant
 */
module.exports.EVENT_PAUSE = 'pause';

/**
 * Indicates that the player has begun/resumed playing.
 * @constant
 */
module.exports.EVENT_PLAY = 'play';

/**
 * Indicates that the player has been stopped and the playback state has been
 * reset.
 * @constant
 */
module.exports.EVENT_STOP = 'stop';
