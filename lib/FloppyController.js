...
module.exports = function(port) {
   ...
   */
  this.setFrequency = function(drive, frequency) {
    // @TODO check ranges
   ...
   */
  this.setNote = function(drive, note, accidental, octave) {
    self.setFrequency(drive, music.pitchToFrequency(note, accidental, octave));
  };
