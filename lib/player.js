...
/**
 * The last notes fired. Used when restarting from a pause.
 * @type {Object.<number, number>}
 */
Player.prototype.active = {};
 ...
 *   The changes to load.
 */
Player.prototype.loadChanges = function(changes) {
...
/**
 * Loads a song from a list of note objects.
 *
 ...
 */
Player.prototype.loadNotes = function(notes) {
  var changes = {};
  ...
  notes.forEach(function(note) {
    ...
    changes[start][note.voice] = music.pitchToFrequency(
